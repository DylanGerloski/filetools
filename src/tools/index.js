...
const compareCsv = require('./compare-csv.js');

const TOOLS = [pdfMerge, pdfSplit, pdfRotate, pdfTablesToCsv, statementToCsv, htmlTableToCsv, dedupeLines, sortLines, flattenJson, jsonToCsv, mergeCsv, compareCsv];
