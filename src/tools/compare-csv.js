...
module.exports = {
  ...
  title: 'Compare Two CSV Files (Cell-by-Cell Diff) - In Your Browser | filetools',
  metaDescription: 'Compare two CSV files free, cell by cell, with no upload and no sign-up. Added, removed, and changed rows are highlighted even when rows are reordered - pick a unique ID column and row order stops mattering entirely.',
