...
function copyVendor() {
  ...
  // as pdf-lib/pdfjs-dist above: self-hosted so xlsx-to-csv keeps working
  // with Wi-Fi off, never a CDN.
  copy(
  ...
  console.log('vendor/ populated from node_modules (pdf-lib, pdfjs-dist, fflate, space-grotesk).');
}
